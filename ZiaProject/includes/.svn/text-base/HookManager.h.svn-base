...
class	HookManager
{
 public:
  ...
  void			createPoolFilter(const zia::filter::IFilter*, Plugin*, std::list<PoolFilter*>&); /*!< Choisis le bon Hook dans lequel ajouter le Pool */
  bool			removePoolFilter(PoolFilter *, HookType);
