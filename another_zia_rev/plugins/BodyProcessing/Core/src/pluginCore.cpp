...
{
  this->_logger = logger;
  //this->_fileExistFilter->setLogger(configurator);
  //this->_checkMethodFilter->setLogger(configurator);
  //this->_genericTypeFilter->setLogger(configurator);
  //this->_accessRightsFilter->setLogger(configurator);
}
