...
void	HookManager::createPoolFilter(const zia::filter::IFilter* filter, Plugin* const plugin, std::list<PoolFilter*>& listPool)
{
...
bool	HookManager::removePoolFilter(PoolFilter * const pool, HookType currentHook)
{
